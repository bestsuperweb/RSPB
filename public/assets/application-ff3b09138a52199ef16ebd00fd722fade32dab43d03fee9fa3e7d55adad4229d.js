...
(function() {
  $('input[type=radio][name=clipping_path_option]').change(function(e) {
    ...
    if (this.value === 'clipping_path') {
      return $(".clipping_path_category_block").show(300);
    } else if (this.value === 'multiple_clipping_path') {
      return $(".multiple_clipping_path_category_block").show(300);
    } else if (this.value === 'advanced_photoshop_mask') {
      return $(".advanced_photoshop_mask_category_block").show(300);
    }
  });

  $("#retouching").change(function(e) {
    if ($(this).is(':checked')) {
      return $(".retouching_category_block").show(300);
    } else {
      return $(".retouching_category_block").hide(300);
    }
  });

  $("#invisible_mannequin").change(function(e) {
    if ($(this).is(':checked')) {
      return $(".invisible_mannequin_category_block").show(300);
    } else {
      return $(".invisible_mannequin_category_block").hide(300);
    }
  });

  $("#color_variants").change(function(e) {
    if ($(this).is(':checked')) {
      return $(".color_variants_block").show(300);
    } else {
      return $(".color_variants_block").hide(300);
    }
  });

  $('input[type=radio][name=shadow_effect_option]').change(function(e) {
    ...
    if (this.value === 'drop_shadow') {
      return $(".drop_shadow_category_block").show(300);
    } else if (this.value === 'existing_shadow') {
      return $(".existing_shadow_category_block").show(300);
    } else if (this.value === 'natural_shadow') {
      return $(".natural_shadow_category_block").show(300);
    } else if (this.value === 'floating_shadow') {
      return $(".floating_shadow_category_block").show(300);
    } else if (this.value === 'mirror_effect') {
      return $(".mirror_effect_category_block").show(300);
    }
  });

  $("#add_another_variant").click(function() {
    var clone, tr;
    tr = $('.color_variant_tr_clone:last');
    clone = tr.clone();
    clone.find(':text').val('');
    return tr.after(clone);
  });

  $("#add_another_copy").click(function() {
    var clone, count, div;
    ...
    return div.after(clone);
  });

  $(".radio-with-image label").click(function() {
    var option, service;
    ...
    return $.ajax('/admin/quotations_samples', {
      type: 'GET',
      data: {
        'service': service,
        'option': option
      ...
      error: function(jqXHR, textStatus, errorThrown) {
        return $("#modal-more-samples .modal-body").html("AJAX Error: " + textStatus);
      },
      success: function(data, textStatus, jqXHR) {
        return $("#modal-more-samples .modal-body").html(data);
      }
    });
  });

  $(function() {
    return $("#modal-more-samples .modal-body").css({
      'overflow': 'auto'
    });
  });

  $(function() {
    return $(document).on('mouseover', '.category-sample-image', function() {});
  });

}).call(this);
// $(".radio-with-image label").click(function() {
//     //$("#modal-more-samples .modal-body").html('<%= @path %>')
//     $("#modal-more-samples").modal();
// });
// $(".radio-with-image label").click(function() {
//     service = $(this).find('input').attr('name');
...
//     $("#modal-more-samples").modal();
// });
// $("#modal-more-samples .modal-body").css({
//     'overflow': 'auto',
//});
